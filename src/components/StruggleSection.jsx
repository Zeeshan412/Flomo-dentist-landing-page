...
const StruggleSection = () => {
  ...
  const cards = [
    ...
    },
    {
      title: "Team Turnover",
      description:
        "Constant retraining, inconsistent care, and patient frustration due to staff changes.",
    },
    {
      title: "Inefficient Training",
      description:
        "New staff take too long to reach full productivity, affecting practice performance.",
    },
    {
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col items-center mb-6 sm:mb-10 md:mb-16">
          ...
          <div className="w-full sm:w-[320px] md:w-[420px] text-center">
            <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[44px] font-bold text-blue-900 whitespace-normal sm:whitespace-nowrap font-poppins leading-tight sm:leading-snug">
          ...
          <div className="w-full md:w-[550px] flex-shrink-0 mb-8 md:mb-0 flex flex-col items-center md:items-start">
            ...
            <div className="flex flex-col items-center md:items-start w-full">
              {cards.map((card, index) => (
                <StruggleCard key={index} title={card.title} description={card.description} />
              ))}
            </div>
          </div>
