  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 md:px-8">
        <div 
          className="features-heading-container relative mx-auto mb-6 sm:mb-8 w-[160px] sm:w-[180px] md:w-[220px] h-[16px] sm:h-[18px] md:h-[21px]"
        >
          <h2 
            className="text-center uppercase absolute left-1/2 transform -translate-x-1/2 text-lg sm:text-xl md:text-2xl lg:text-[44px] font-bold text-[#072B73] font-sen leading-none"
          >
            Features
          </h2>
        </div>
        ...
        <p 
          className="text-center mx-auto mb-2 text-base sm:text-lg md:text-xl lg:text-2xl font-bold text-[#1E84B5] font-sen leading-tight w-full max-w-[1050px]"
        >
          Reduce stress by keeping your entire team aligned, trained, and on the same page.
        </p>
        
        <p 
          className="text-center mx-auto text-xs sm:text-sm md:text-base font-bold text-[#527282] font-sen leading-normal w-full max-w-[996px] mb-10 sm:mb-12 md:mb-14 lg:mb-16 px-4"
        >
