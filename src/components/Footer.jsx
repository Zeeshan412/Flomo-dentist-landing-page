      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between mb-12">
          ...
          <div className="mb-8 md:mb-0 max-w-sm">
            <img src={Logo} alt="Flomo Logo" className="h-10 mb-6" />
            <p className="text-blue-200 mb-6">
              The first AI-powered documentation platform specifically built for dental practices.
            </p>
            ...
            <ul className="space-y-3">
              <li className="text-blue-200">
                <div className="flex items-start">
                  <svg className="w-5 h-5 mr-2 mt-0.5 text-blue-200" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"></path>
                  </svg>
                  <span>info@flomodentist.com</span>
                </div>
              </li>
              <li className="text-blue-200">
                <div className="flex items-start">
              ...
              <li className="text-blue-200">
                <div className="flex items-start">
                  ...
                  <span>123 Dental Office Way<br />Boston, MA 02110</span>
                </div>
              </li>
            </ul>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center">
          <p className="text-blue-200 text-sm mb-4 md:mb-0">
            © {currentYear} Flomo. All rights reserved.
          </p>
          <div className="flex space-x-6">
            <a href="#" className="text-blue-200 hover:text-white text-sm">Sitemap</a>
            <a href="#" className="text-blue-200 hover:text-white text-sm">Support</a>
            <a href="#" className="text-blue-200 hover:text-white text-sm">FAQ</a>
          </div>
        </div>
      </div>
    </footer>
